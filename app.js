...
// ======================================================
// ALTERNAR CAIXAS / UNIDADES AVULSAS
// ======================================================

function updateProductionMovementFields() {

  const isUnits =
    productionMovementType.value ===
    "unidades";

  productionBoxesGroup.classList.toggle(
    "hidden",
    isUnits
  );

  productionUnitsGroup.classList.toggle(
    "hidden",
    !isUnits
  );
  ...
  productionUnits.required =
    isUnits;
}

productionMovementType.addEventListener(
  "change",
  updateProductionMovementFields
);

updateProductionMovementFields();


function updateExitMovementFields() {

  const isUnits =
    exitMovementType.value ===
    "unidades";

  exitBoxesGroup.classList.toggle(
    "hidden",
    isUnits
  );

  exitUnitsGroup.classList.toggle(
    "hidden",
    !isUnits
  );
...
exitMovementType.addEventListener(
  "change",
  updateExitMovementFields
);
